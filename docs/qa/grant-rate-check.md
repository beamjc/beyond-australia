...
- If the visitor's age group has **fewer than 30 decisions**, the planner uses the **old method** for that group: all-ages average × the original age factor (owner decision 2026-09-24 — the plain average, e.g. 94.6 % for a 37-year-old, was judged too high). These cells are marked *italic* below and flagged `ageSpecific: false` in code. The original age factors have no cited source.
...
What the planner shows (%, 1 d.p.). Plain = official age-group rate; *italic* = small group, old-method estimate.

| Course type | From | All ages (decisions) | 15–19 | 20–24 | 25–29 | 30–34 | 35–39 | 40+ |
|---|---|---|---|---|---|---|---|---|
| University | Thailand | 94.6 (822) | 97.8 | 97.8 | 89.5 | 84.5 | *56.8* | *47.3* |
| University | Australia | 93.4 (470) | 98.0 ¹ | 96.9 | 94.5 | 88.3 | *72.9* | *63.5* |
| English | Thailand | 51.7 (741) | 43.8 | 61.5 | 49.3 | 39.6 | *25.9* | *25.9* |
| English | Australia | 87.3 (355) | *91.7* | 97.5 | 88.4 | 84.3 | *74.2* | *48.0* |
| Vocational | Thailand | 23.8 (101) | *23.8* | *23.8* | *23.8* | *20.2* | *15.5* | *15.5* |
| Vocational | Australia | 63.4 (2,874) | *76.1* | 81.9 | 72.7 | 63.7 | 35.6 | 22.1 |

¹ official 100 % (34/34), shown as 98. Decision counts per group are in `src/data/grantRates.ts`.
